            ...
            <div class="xc18__container">
              ...
              <div class="xc18__item">
                <el-form-item label="服务奖金计提月">
                  <el-date-picker v-model="form2.serviceMonth" style="width:160px" type="month" placeholder="选择月">
                  </el-date-picker>
                </el-form-item>
              </div>
              <div class="xc18__item">
              ...
              <div class="xc18__item">
                <el-form-item label="留存发放月">
                  <el-date-picker v-model="form2.keepMonth" style="width:160px" type="month" placeholder="选择月">
                  </el-date-picker>
                </el-form-item>
              </div>
              <div class="xc18__item">
